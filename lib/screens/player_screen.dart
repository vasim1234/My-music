...
class _PlayerScreenState extends State<PlayerScreen> with SingleTickerProviderStateMixin {
  ...
  void _applyEqualizer() {
    // Apply EQ effects using audio player's setBalance and setVolume
    // Since audioplayers doesn't have native EQ, we simulate using balance and volume
    double bassBoost = _eqValues['bass']!;
    double trebleBoost = _eqValues['treble']!;
    
    // Simulate EQ by adjusting balance and volume
    // Higher bass = slightly lower treble balance
  ...
  void _resetEqualizer() {
    setState(() {
      ...
      _eqValues = Map.from(_eqPresets['Normal']!);
    });
    _applyEqualizer();
  }
  ...
  void _applyPreset(String presetName) {
    setState(() {
      ...
      _eqValues = Map.from(_eqPresets[presetName]!);
    });
    _applyEqualizer();
                    ...
                    child: ListView(
                      children: [
                        _buildEqSlider(
                          ...
                          color: Colors.blue,
                          value: _eqValues['bass']!,
                          onChanged: (value) {
                            setState(() {
                              _eqValues['bass'] = value;
                        ...
                        _buildEqSlider(
                          ...
                          icon: Icons.music_note,
                          color: Colors.cyan,
                          value: _eqValues['lowMid']!,
                          onChanged: (value) {
                            setState(() {
                              _eqValues['lowMid'] = value;
                              _currentEqPreset = 'Custom';
                            });
                            setModalState(() {});
                            _applyEqualizer();
                        ...
                        _buildEqSlider(
                          ...
                          icon: Icons.music_note,
                          color: Colors.orange,
                          value: _eqValues['highMid']!,
                          onChanged: (value) {
                            setState(() {
                              _eqValues['highMid'] = value;
                              _currentEqPreset = 'Custom';
                            });
                            setModalState(() {});
                            _applyEqualizer();
                        ...
                        _buildEqSlider(
                          ...
                          icon: Icons.music_note,
                          color: Colors.red,
                          value: _eqValues['treble']!,
                          onChanged: (value) {
                            setState(() {
                              _eqValues['treble'] = value;
                              _currentEqPreset = 'Custom';
                            });
                            setModalState(() {});
                            _applyEqualizer();
  ...
  Future<void> _playCurrentSongInQueue() async {
    ...
    try {
      ...
      if (currentFile.path != null) {
        ...
        _applyEqualizer(); // Apply EQ when song starts
            ...
            trailing: Row(
              ...
              children: [
                IconButton(
                  ...
                  onPressed: () {
                    setState(() {
                      _customPlaylists.remove(playlistName);
                    });
                  },
                ),
              ],
            ...
            children: songs.isEmpty
                ? [
                    const Padding(
                      ...
                      child: Text('No songs in this playlist', style: TextStyle(color: Colors.white54)),
                    ),
                  ]
                : songs.map((song) {
                    return ListTile(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Bottom Action Controls - Added EQ Chip
            Padding(
                ...
                child: Row(
                  ...
                  children: [
                    _buildActionChip(
                      ...
                      label: isCurrentFavorite ? 'Favorite' : 'Add Fav',
                    ...
                    _buildActionChip(
                      ...
                      label: isEqActive ? _currentEqPreset : 'EQ',
                      isActive: isEqActive,
